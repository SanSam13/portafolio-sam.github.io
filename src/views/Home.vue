          ...
          <div class="container">
              <div class="row">
                  <div class="col-xs-12 col-md-12 col-lg-6">
                        <div class="image">
                            <img src="../assets/sam3.jpg" alt="Mi foto">
                        </div>
                        <div class="icon">
                  ...
                  <div class="col-xs-12 col-md-12 col-lg-6">
                      <div class="description">
                            ...
                            <h2>Hola, ¿Qué tal?</h2>
                            <p>Yo soy Sandra, egresada de la carrera de Ingeniería en Sistemas Computacionales.
                            ...
                            <a href="https://cv-sandra-mtz.netlify.app/cv/cv_SandraMtz2021.pdf" class="btn btn-1 dowloand" download target="_blank">
                                <svg>
